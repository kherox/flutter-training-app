...
class _ProductEditPageState extends State<ProductEditPage> {
  ...
  Widget _buildSubmitButton(){
    return ScopedModelDescendant(builder: (BuildContext context , Widget child , ProductsModel model) {
      return  RaisedButton(
                ...
                onPressed: () => _submitForm(model.addProduct,model.updateProduct , model.selectedIndex),
              );
    },);
  }
  ...
  void _submitForm(Function addProduct , Function updateProduct , [int selectProductIndex]) {
